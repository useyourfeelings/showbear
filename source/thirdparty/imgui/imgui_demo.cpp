    ...
    if (ImGui::CollapsingHeader("Widgets"))
    {
        ...
        if (ImGui::TreeNode("Images"))
        {
            ...
            if (ImGui::IsItemHovered())
            {
                ...
                ImGui::Text("std::min: (%.2f, %.2f)", focus_x, focus_y);
        ...
        if (ImGui::TreeNode("Range Widgets"))
        {
            ...
            ImGui::DragFloatRange2("range", &begin, &end, 0.25f, 0.0f, 100.0f, "std::min: %.1f %%", "Max: %.1f %%");
            ImGui::DragIntRange2("range int (no bounds)", &begin_i, &end_i, 5, 0, 0, "std::min: %.0f units", "Max: %.0f units");
